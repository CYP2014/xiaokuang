...
const msg = {
  ...
  1004: i18n.t('message.1004'),
  1005: i18n.t('message.1005'),
  ...
  4008: i18n.t('message.4008'),
  4009: i18n.t('message.4009'),
  4010: i18n.t('message.4010'),
  4011: i18n.t('message.4011'),
  4012: i18n.t('message.4012'),
  4013: i18n.t('message.4013'),
  4014: i18n.t('message.4014'),
  4015: i18n.t('message.4015'),
  4016: i18n.t('message.4016'),
  4017: i18n.t('message.4017'),
  4018: i18n.t('message.4018'),
  4019: i18n.t('message.4019'),
  4020: i18n.t('message.4020'),
  4021: i18n.t('message.4021'),
  4022: i18n.t('message.4022'),
  4023: i18n.t('message.4023'),
  4024: i18n.t('message.4024'),
  4025: i18n.t('message.4025'),
  4026: i18n.t('message.4026'),
  4027: i18n.t('message.4027'),
  4028: i18n.t('message.4028'),
  4029: i18n.t('message.4029'),
  4030: i18n.t('message.4030'),
  4031: i18n.t('message.4031'),
  4032: i18n.t('message.4032')
}
